...
export type SettleWalletTopupInput = {
  paymentId: string;
  actor: string;
...
export type SettleWalletTopupResult = {
  paymentId: string;
  walletId: string;
...
export const settleWalletTopup =
  async (
    input: SettleWalletTopupInput
    ...
    const result =
      ...
      async (transaction) => {
        ...
        if (
          ...
          throw new Error(
            'Payment is not a Runtime Credit top-up.'
          );
        }
        ...
        if (
          ...
          throw new Error(
            'This top-up can no longer be verified.'
          );
        }
            ...
            transaction.set(
              paymentRef,
              {
                ...
                provider_status_description:
                  input.providerStatusDescription ||
    ...
    if (!result.alreadySettled) {
      try {
        ...
        console.error(
          'Runtime Credit top-up email failed:',
          error
        );
      }
    }
