...
const getEncryptionKey =
  () => {
    ...
    if (
      ...
      throw new Error(
        'TRANSFER_SECRET_KEY must be configured as 64 hexadecimal characters.'
      );
    }
...
router.post(
  ...
  async (
    ...
    try {
        ...
        return res
          ...
          .json({
            success:
              false,
            message:
              'Order, domain and authorization code are required.',
          });
      }
        ...
        return res
          ...
          .json({
            success:
              false,
            message:
              'You cannot update this transfer order.',
          });
      }
        ...
        return res
          ...
          .json({
            success:
              false,
            message:
              'This is not a domain transfer order.',
          });
      }
        ...
        return res
          ...
          .json({
            success:
              false,
            message:
              'The domain does not match the transfer order.',
          });
      }
      ...
      console.error(
        'Unable to store transfer authorization:',
        error
      );
  ...
  async (
    ...
    try {
        ...
        return res
          ...
          .json({
            success:
              false,
            message:
              'Transfer authorization is locked until payment is verified.',
          });
      }
      ...
      if (
        ...
        throw new Error(
          'Encrypted transfer authorization is incomplete.'
        );
      }
      ...
      console.error(
        'Unable to read transfer authorization:',
        error
      );
