...
router.get(
  ...
  async (
    ...
    try {
      ...
      console.error(
        'Unable to load synced admin users:',
        error
      );
    ...
    try {
        ...
        return res
          ...
          .json({
            success:
              false,
            message:
              'Super admin accounts cannot be edited from the customer screen.',
          });
      }
      ...
      await adminDb
        ...
        .add({
          ...
          description:
            `${req.runtimeUser!.email} updated customer profile ${email}.`,
    ...
    try {
        ...
        return res
          ...
          .json({
            success:
              false,
            message:
              'Only customer accounts can be deleted from this screen.',
          });
      }
      ...
      if (
        ...
        return res
          ...
          .json({
            ...
            message:
              'Type the customer email exactly to confirm account deletion.',
          });
      }
      ...
      await adminDb
        ...
        .add({
          ...
          description:
            `${req.runtimeUser!.email} deleted customer account ${email}.`,
      ...
      console.error(
        'Admin customer deletion failed:',
        error
      );
