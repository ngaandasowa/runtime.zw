...
export const GuidePage: React.FC = () => {
  ...
  useEffect(()=>{
    if(!guide)return;const canonical=`${SITE_URL}/guides/${guide.slug}`;const title=guide.seo_title||`${guide.title} | Runtime Guide`;const description=guide.meta_description||guide.excerpt;const image=guide.featured_image||`${SITE_URL}/new-og-image-01.webp`;document.title=title;
