...
export const AdminSettings: React.FC = () => {
  ...
  const [techName, setTechName] = useState(settings.operator_name);
  const [techEmail, setTechEmail] = useState(settings.support_email);
  const [techPhone, setTechPhone] = useState(settings.operator_phone);
  const [autoSubmit, setAutoSubmit] = useState(settings.auto_submit_registry);
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    updateSettings({
      ...
      operator_name: techName,
      support_email: techEmail,
      operator_phone: techPhone,
      auto_submit_registry: autoSubmit,
    });
