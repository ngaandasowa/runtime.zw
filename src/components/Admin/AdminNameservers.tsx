...
export const AdminNameservers: React.FC = () => {
  ...
  const [ns1, setNs1] = useState(settings.default_nameserver_1);
  const [ns2, setNs2] = useState(settings.default_nameserver_2);
  const [ns3, setNs3] = useState(settings.default_nameserver_3);
  const [ns4, setNs4] = useState(settings.default_nameserver_4);
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    setError(null);
    updateSettings({
      default_nameserver_1: ns1.trim(),
      default_nameserver_2: ns2.trim(),
      default_nameserver_3: ns3.trim(),
      default_nameserver_4: ns4.trim(),
    });
